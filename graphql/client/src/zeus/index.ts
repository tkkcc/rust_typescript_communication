...
export type ValueTypes = {
    ["Query"]: AliasType<{
add?: [{	a: number | Variable<any, string>,	b: number | Variable<any, string>},ValueTypes["User"]],
add2?: [{	a: number | Variable<any, string>,	b: number | Variable<any, string>},ValueTypes["User"]],
		__typename?: boolean | `@${string}`
}>;
	["Subscription"]: AliasType<{
	/** Counts seconds. */
	count?:ValueTypes["User"],
		__typename?: boolean | `@${string}`
}>;
	["User"]: AliasType<{
	name?:boolean | `@${string}`,
	related?:ValueTypes["User"],
		__typename?: boolean | `@${string}`
}>
  }
...
export type ResolverInputTypes = {
	...
	["Query"]: AliasType<{
add?: [{	a: number,	b: number},ResolverInputTypes["User"]],
add2?: [{	a: number,	b: number},ResolverInputTypes["User"]],
		__typename?: boolean | `@${string}`
}>;
	["Subscription"]: AliasType<{
	/** Counts seconds. */
	count?:ResolverInputTypes["User"],
		__typename?: boolean | `@${string}`
}>;
	["User"]: AliasType<{
	name?:boolean | `@${string}`,
	related?:ResolverInputTypes["User"],
		__typename?: boolean | `@${string}`
}>
  }
...
export type ModelTypes = {
	...
	add: ModelTypes["User"],
	/** Adds two `a` and `b` numbers. */
	add2: ModelTypes["User"]
};
	["Subscription"]: {
		/** Counts seconds. */
	count: ModelTypes["User"]
};
	["User"]: {
		name: string,
	related: Array<ModelTypes["User"]>
}
    }
...
export type GraphQLTypes = {
	...
	__typename: "Query",
	/** Adds two `a` and `b` numbers. */
	add: GraphQLTypes["User"],
	/** Adds two `a` and `b` numbers. */
	add2: GraphQLTypes["User"]
};
	["Subscription"]: {
	__typename: "Subscription",
	/** Counts seconds. */
	count: GraphQLTypes["User"]
};
	["User"]: {
	__typename: "User",
	name: string,
	related: Array<GraphQLTypes["User"]>
}
    }
